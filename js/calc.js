function calcular() {
  var sueldoBruto = $("#sueldoBruto").val(),
    ...
    valorDomestico = $("#domestico").val(),
    deduccionHipotecario = 12 * valorHipotecario > TOPE_HIPOTECARIO ? TOPE_HIPOTECARIO : 12 * valorHipotecario,
    deduccionDomestico = 13 * valorDomestico > TOPE_DOMESTICO ? TOPE_DOMESTICO : 13 * valorDomestico,
  ...
  mniTotal = (mniConDeduccionEspecial + CONYUGE * isConyuge + HIJO * cantHijos + deduccionAlquiler + deduccionHipotecario + deduccionDomestico) * (1 - isJubilado) + isJubilado * (TOPE_JUBILADO + deduccionAlquiler + deduccionHipotecario + deduccionDomestico),
...
var topesEscalas = [2e4, 4e4, 6e4, 8e4, 12e4, 16e4, 24e4, 32e4, 99999999],
  ...
  TOPE_DOMESTICO = MINIMO_NO_IMPONIBLE;
